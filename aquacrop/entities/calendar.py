...
class Calendar:
    ...
    """
    def __init__(self, name: str, description: str, onset_mode: int = 0, 
                 day_number: int = 1, window_start_day: int = 1, window_length: int = 90,
                 criterion_number: int = 1, criterion_value: float = 20.0,
                 successive_days: int = 1, occurrences: int = 1):
        """
